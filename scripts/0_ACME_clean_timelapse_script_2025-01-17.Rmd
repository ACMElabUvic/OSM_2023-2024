...
write_csv(OSM_2023_deploy,
          './data/processed/OSM_2023_deployment.csv')
...
OSM_2023_deploy <- read_csv('data/processed/OSM_2023_deployment.csv') %>% 
...
write.csv(OSM_2023_data_clean %>% mutate(datetime = paste0(" ", format(datetime, format = "%Y-%m-%d %H:%M:%S"))), 
          file = 'data/processed/OSM_2023_data_clean.csv',
          na = "", row.names = FALSE)
...
with_dir(new = my_netdrive, 
  ...
  write.csv(OSM_2023_data_clean %>% mutate(datetime = paste0(" ", format(datetime, format = "%Y-%m-%d %H:%M:%S"))), 
            file = '2. Timelapse Files/OSM_2023_data_clean.csv',
            na = "", row.names = FALSE)
  )
